...
export default class BChain {
	...
	*/
	...
	addNode(ip, command): Observable<Object> { return this.call('addnode', [ip, command]);}
	...
	appendRawWata(tx, data): Observable<Object> { return this.call('appendrawwata', [tx, data]);}
	...
	createKeyPairs(): Observable<Object> { return this.call('createkeypairs', []);}
	...
	createRawTransaction(inputs, amounts): Observable<Object> { return this.call('createrawtransaction', [inputs, amounts]);}
	...
	getAddedNodeinfo(verbose): Observable<Object> { return this.call('getaddednodeinfo', [verbose]);}
